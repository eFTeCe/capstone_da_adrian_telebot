...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "Adrian Djaya Prathama",
            BATCH_ACADEMY = "Yoda",
            GITHUB_REPO_LINK = "https://github.com/eFTeCe/capstone_da_adrian_telebot"
        )
...
unique_campaign = df['campaign_id'].array.unique()
...
def echo_all(message):
    ...
    with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
        ...
        default = temp.substitute(EMOJI = emoji.emojize(':cross_mark:'))
